...
public abstract class BaseFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		if (mLoadingPager == null) {// 第一次执行
			mLoadingPager = new LoadingPager(UIUtils.getContext()) {//默认返回正在加载的framelayout
				@Override
				public LoadedResult initData(String date) {
					return BaseFragment.this.initData(date);
				}
	...
	*/
	 ...
	 */
	public abstract LoadingPager.LoadedResult initData(String date);
