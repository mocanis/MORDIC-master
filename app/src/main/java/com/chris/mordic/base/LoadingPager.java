...
public abstract class LoadingPager extends FrameLayout {
	...
	*/
	...
	class LoadDataTask implements Runnable {
		...
		public void run() {
			// ② 异步加载数据
			LoadedResult tempState = initData(HomeFragment.mToday);
			//LoadedResult tempState1 = initData(DateUtils.getpreDate(HomeFragment.mToday,0));
			// 处理加载结果
	 ...
	 */
	//加载数据并返回数据加载是否成功的状态值
	public abstract LoadedResult initData(String date);
