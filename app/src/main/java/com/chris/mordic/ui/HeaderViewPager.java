...
public class HeaderViewPager extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        measureChildWithMargins(mHeadView, widthMeasureSpec, 0, MeasureSpec.UNSPECIFIED, 0);//测量孩子mHeadView,可测padding和margin
        //mHeadView.measure(widthMeasureSpec,MeasureSpec.UNSPECIFIED);
        mHeadHeight = mHeadView.getMeasuredHeight();
        System.out.println("mHeadHeight:"+mHeadHeight);
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (verticalScrollFlag && (!isStickied() || mScrollable.isTop() || isClickHead)) {
                    ...
                    //invalidate();//scrollBy是直接生效,不需要invalidate()
                }
                break;
